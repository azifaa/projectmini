        ...
        <div class="card mt-5 w-50 justify-content-center mx-auto bg-transparent">
          ...
          <div class="card-body">
            <form action="connect_register.php" method="post">
              <div class="mb-2">
                <label for="exampleInputEmail1" class="form-label text-white text-bold "
                  placeholder="Email Address">Email address</label>
              ...
              <div class="mb-2">
                <label for="exampleInputUserName" class="form-label text-white text-bold " placeholder="User Name">User
                  Name</label>
                <input name="username" type="username" class="form-control" id="exampleInputUserName"
                  placeholder="username">
              </div>
              <div class="mb-2">
                <label for="exampleInputPassword1" class="form-label text-white text-bold"
